...
export class DataInputComponent {
    ...
    @Input() public lockValue = false;
    @Input() public error = false;
    @Input() public view = false;
    @Input() public regex: any = null;
    @Input() public errorMsg = 'Input not valid';
    @Input() public infoMsg = '';
    @Input() public disabled = false;
    @Input() public required = false;
    @Input() public validation = true;
    @Input() public decimals = true;
    ...
    private alphanumeric = '1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
