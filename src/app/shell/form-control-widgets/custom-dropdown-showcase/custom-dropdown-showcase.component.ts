...
@Component({
    ...
    templateUrl: './custom-dropdown-showcase.template.html',
    styleUrls: ['./custom-dropdown-showcase.styles.scss']
})
export class CustomDropdownShowcaseComponent {
    public model: any = {
    ...
    public ngOnInit() {
        ...
        this.model.inject = `&lt;custom-dropdown name=&quot;question&quot;
